...
public interface GenericDao<T, PK extends Serializable> {
	...
	List<Object> findBySQL(String sqlStr, Map<String, Object> queryParams, int firstResult, int maxResults);
	...
	void insert(String sql, Map<String, Object> parameters);
	void saveOrUpdateAll(Collection<T> entities);
	
	
	// add by Mcihelle begin ----
	
	T saveRmUserFrushHibernate(T object);
